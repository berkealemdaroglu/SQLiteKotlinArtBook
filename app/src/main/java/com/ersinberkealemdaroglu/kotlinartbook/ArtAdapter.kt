...
import com.ersinberkealemdaroglu.kotlinartbook.databinding.ActivityReceyclerRowBinding

class ArtAdapter (val artList : ArrayList<Art>): RecyclerView.Adapter<ArtAdapter.ArtHolder>() {
    class ArtHolder(val binding: ActivityReceyclerRowBinding) : RecyclerView.ViewHolder(binding.root){

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ArtHolder {
        val binding = ActivityReceyclerRowBinding.inflate(LayoutInflater.from(parent.context),parent,false)
